...
module.exports.models = {
  ...
  ***************************************************************************/
  ...
  // Schema validation - keep it flexible for MongoDB
  schema: true,

  // Auto-migration strategy
  // 'safe' - no auto-migrations (production mode)
  // 'alter' - auto-migrate columns/fields (development)  
  // 'drop' - drop all tables/collections and rebuild
  migrate: 'safe',
  ...
  ******************************************************************************/
  ...
  dataEncryptionKeys: {
    default: 'noojrqPX1NXhA8Y+HFR11Y/Wtjog3sx04umoBWcfZxs='
  },
